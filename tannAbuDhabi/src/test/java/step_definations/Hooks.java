...
public class Hooks {
	...
	public static boolean takeAllScrShots = Boolean.parseBoolean(JavaUtils.javaUtilsSelfObj.getSystemProperty("TAKE_ALL_SCREENSHOTS", "false"));
    ...
    /**
	 * This Scenario Startup method runs automatically before each Scenarios defined inside the each cucumber feature files
	 * and which creates the driver instance and Logs the scenarios startup.
	 *
	...
	public void takeScreenShot(Scenario scenario) {
		...
		if(scenario.isFailed()) {
			...
			byte[]screen=((TakesScreenshot)utilsManager.seleniumUtils.getDriver()).getScreenshotAs(OutputType.BYTES);
    ...
    /**
	 * This Scenario end up method runs automatically after each Scenarios defined inside the each cucumber feature files
	 * and quit the driver if scenarios got fail and logs the scenario wind-up.
	 * 
	 *
	 *@param scenario : passing cucumber's Scenario object variable.
	 */
   ...
   /**
    * This Method is created or can be utilize to take the necessary action automatically before each Steps defined for the scenarios.
    *
    */
	@BeforeStep
    ...
    /**
	 * This method runs automatically after each Steps defined for the scenarios for taking the all the test screen's screenshot of test
	 * execution if TAKE_ALL_SCREENSHOTS(default:false) environment property set as true or if not explicitly skipped on particular step.
	 * 
	 *
	 *@param scenario : passing cucumber's Scenario object variable.
	 */
